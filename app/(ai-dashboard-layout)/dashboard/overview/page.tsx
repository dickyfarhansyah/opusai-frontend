...
export default function DashboardOverviewPage() {
	...
	return (
		<div className="flex flex-col">
			<header className="flex gap-6 px-4 py-2 rounded-2xl">
			...
			<main className="grid grid-cols-12 px-4 py-2 gap-4">
				<div className="grid col-span-12 grid-cols-12 gap-4">
					...
					<div className="col-span-4 rounded-2xl p-4 min-h-96 bg-card text-card-foreground">
						<div className="flex flex-col flex-1 gap-4">
							...
							<div className="flex flex-col border flex-1 gap-2 p-2 rounded-lg">
